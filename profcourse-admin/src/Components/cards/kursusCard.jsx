...
export default function KursusCard(props){
    ...
    return(
        <div class="card shadow col p-0 h-25" style={{'border-radius':'15px','border':'none', maxWidth: '20rem', height:'30rem'}}>
        <img src={url_image} class="card-img-top p-0 m-0 w-100" alt={`${title}`} style={{ objectFit: "cover", 'border-radius':'15px 15px 0px 0px' }}/>
<div class="card-body">
