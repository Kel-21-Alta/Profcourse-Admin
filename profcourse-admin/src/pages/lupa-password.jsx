...
export default function LupaPassword(){
  ...
  const onChange = (e) => {
   ...
   function resetPassword() {
    ...
    axios.put('http://3.133.85.122:9090/api/v1/forgetpassword', {
      "email": email
    })
      ...
      >
          <div className="container px-5" >
              <div class="shadow-lg mx-lg-3" style={{'color':'#152C5B'}}>
                  ...
                  {isLoading? <div className="text-center">Loading...</div>: isReset? <div className="text-center">Password baru sudah dikirim ke email anda.</div>:<form onSubmit={handleSubmit} className="needs-validation" novalidate>
        ...
        {errorMessage}
                  ...
                  <div className="form-group">
                      ...
                      >
                        <Link to="/"> <button type="link" href="/" className="btn btn-link" style={{ fontSize: "12px" }}>
