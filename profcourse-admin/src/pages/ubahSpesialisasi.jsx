        ...
        <div class="row flex-nowrap">
          ...
          <div class="col py-3">
            ...
            <div className="mx-5 my-3">
                <h1 className="fw-bold">Ubah Spesialisasi</h1>
               </div>
               ...
               <div className="border my-3" style={{'border-radius':'15px'}}>
                <div className="row m-3 p-3">
                  <div className="col-md-6 text-center">
                    ...
                    />
                    <input type="file" name="file" id="file" className="btn btn-thirtiery form-control"/>
                  </div>
                    ...
                    <form action="#" className="signin-form">
                      <div className="form-group mb-3">
                        <div>
                          ...
                          <input type="text" class="form-control" id="judul" placeholder="Judul Spesialisasi" required/>
                        </div>
                      </div>
                      <div className="form-group mb-3">
                        <label
                        ...
                        <textarea class="form-control" id="deskripsi" rows="3" placeholder="Deskripsi Spesialisasi" required></textarea>
                      </div>
                    </form>
                  </div>
                </div>
              ...
              <div className="d-flex justify-content-end">
                <button type="button"class="btn btn-thirtiery align-item-end shadow">Submit</button>
                </div>
               </div>
          </div>
        </div>
